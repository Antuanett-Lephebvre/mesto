...
function handleAddProfileButtonClick(e) { 
    ...
    if (closeButtonProfile.classList.contains('button_type_closed') || closeButtonProfile.classList.contains('button_type_submit')) 
    { 
...
popupProfileNode.addEventListener('submit', handleFormSubmit); 
